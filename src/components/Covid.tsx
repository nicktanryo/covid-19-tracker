...
export const SelectedCountryContext = React.createContext<CSelectedCountryContext | undefined>(undefined)
...
export default function Covid(): ReactElement {
    ...
    const [selectedCountryData, setSelectedCountryData] = useState<InfoBarData | undefined>(undefined)
    ...
    useEffect(() => {
        async function getdata() {
            ...
            if (selectedCountry === "WORLDWIDE") setCoordinate(centerCoordinate)
            else countries.getCountryLocation(selectedCountry as String)
                .then(({ lat, long }) => {
            ...
            <SelectedCountryContext.Provider value={{ selectedCountry, setSelectedCountry }}>
                <ViewTypeContext.Provider value={viewType}>
                    <Grid container direction="row" justify="space-between">
                        ...
                        <Grid item xs={12} md={6} lg={8} container direction="column" justify="space-between">
                            <Grid item>
                                <Header />
                            </Grid>
                            ...
                            <Grid item container justify="space-around" spacing={1}>
                                <InfoBar selectedCountryData={selectedCountryData} setViewType={setViewType} />
                            </Grid>
                        </Grid>

                        <Grid item xs={12} md={6} lg={4} container direction="column" justify="space-between">
                            <Grid item> {/*/xs={12}*/}
                                <Table />
                            </Grid>
